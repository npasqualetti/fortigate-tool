  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 flex w-[calc(100vw-2rem)] min-w-0 max-h-[min(90dvh,calc(100vh-2rem))] max-w-2xl -translate-x-1/2 -translate-y-1/2 flex-col gap-4 overflow-hidden rounded-xl border border-[var(--border)] bg-white p-6 shadow-lg",
          className
        )}
        {...props}
      >
